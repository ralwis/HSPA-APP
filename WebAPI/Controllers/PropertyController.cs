...
namespace WebAPI.Controllers
{
    public class PropertyController : BaseController
    {
        ...
        public async Task<ActionResult<PhotoDto>> AddPropertyPhoto(IFormFile file, int propId)
        {
            ...
            return BadRequest("Some problem occured while uploading photo, please try again");
        }

        //property/set-primary-photo/1/fvsvsvcvvsbf
        ...
        public async Task<IActionResult> SetPrimaryPhoto(int propId, string photoPublicId)
        {
            ...
            if(property == null)
            {
                return BadRequest("No such property of photo exist");
            }
        ...
        //property/delete-photo/1/fvsvsvcvvsbf
